...
class Car extends JPanel implements ActionListener {
    ...
    private final int cx = 300;
    private final int cy = 300;
    private int minCircle = 3;
    private int maxCircle = 10;
    private int diff = maxCircle - minCircle;
    private int diff2 = maxCircle + minCircle;
    private int n11, m11, n31, m31, n12, m12, n32, m32, n13, m13, n33, m33, n14, m14, n34, m34;
    private int a1 = 0, a2 = 180, a3 = 90, a4 = 270;
    private int x = 0, y = 0;
    private int count = 0;
